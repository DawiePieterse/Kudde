...
const SHELL = [
  ...
  // See the field worker: the stylesheet without the font is a screenful of
  // empty boxes the first time this loads with no connection.
